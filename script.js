...
const questions = [
    ...
    ["돌려 줄 생각이 없으면서 돈을 요구하는 행위를 한 적이 있다.", "옷, 문구류 등을 빌린다며 되돌려주지 않는 행위를 한 적이 있다.", "일부러 물품을 망가뜨리는 행위를 한 적이 있다.", "돈을 걷어오라고 하는 행위를 한 적이 있다.", "흉기로 위협해 돈을 가져가는 행위를 한 적이 있다.","주머니를 뒤져서 돈을 가져가는 행위","몰래 물건이나 돈을 가져가는 행위를 한 적이 있다."],
    ["빵셔틀을 시킨 적이 있다.", "심부름 강제로 시킨 적이 있다.", "와이파이나 테더링 공유를 강요한 적이 있다.", "과제 대행을 시킨 적이 있다.", "게임 대행을 시킨 적이 있다."],
    ["여럿이 함께 피해 학생을 의도적, 반복적으로 피하는 행위를 한 적이 있다.", "바보 취급, 놀리기, 빈정거림, 면박주기, 겁주기, 골탕 먹이기, 비웃기, 욕하기 행위를 한 적이 있다.", "피해 학생이 다른 친구들과 놀지 못하도록 막는 행위를 한 적이 있다."],
    ["폭행, 협박을 통해 성행위를 강제하거나 유사 성행위, 성기에 이물질을 삽입하는 등의 행위를 한 적이 있다.", "상대방에게 폭행과 협박을 하면서 성적 모멸감을 느끼도록 신체적 접촉을 하는 행위를 한 적이 있다.", "성적인 말과 행동을 통해 설적 굴욕감, 수치감을 느끼도록 하는 행위를 한 적이 있다.", "성적 접촉을 하고 도망가는 행위를 한 적이 있다."],
    ["속칭 사이버모욕, 사이버명예훼손, 사이버성희롱, 사이버스토킹, 사이버음란물 유통, 대화명 테러, 인증놀이, 게임부주 강요 등 정보통신기기를 이용하여 괴롭히는 행위를 한 적이 있다.", "특정인에 대해 모욕적 언사나 욕설 등을 인터넷 게시판, 채팅, 카페 등에 올리는 행위(특정인에 대한 저격글이 그 한 형태임)를 한 적이 있다.", 
     "특정인에 대한 허위 글이나 개인의 사생활에 관한 사실을 인터넷, SNS 등을 통해 불특정 다수에 공개하는 행위를 한 적이 있다.", "성적 수치심을 주거나, 위협하는 내용, 조롱하는 글, 그림, 동영상 등을 정보통신망을 통해 유포하는 행위를 한 적이 있다.", "공포심이나 불안감을 유발하는 문자, 음향, 영상 등을 휴대폰 등 정보통신망을 통해 반복적으로 보내는 행위를 한 적이 있다.","헤어진 여자친구에게 불안감을 조성하는 문자를 지속적으로 보내는 행위를 한 적이 있다."]
];
